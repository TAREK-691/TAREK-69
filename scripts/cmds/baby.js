...
module.exports.onChat = async ({
    ...
    try {
        ...
        if (body.startsWith("baby") || body.startsWith("bby") || body.startsWith("bot") || body.startsWith("jan") || body.startsWith("babu") || body.startsWith("janu") || body.startsWith("বট") || body.startsWith("জান") || body.startsWith("জানু") || body.startsWith("বাবু")) {
            ...
            const rawReplies = [
              "_আমার বস Tarek এর মন খারাপ 🥺",
              "তুই কি Wi-Fi? কাছে এলেই কানেকশন হারায়া ফেলি 😵",
              "Hmm bolo 🐹",
              "_বট বট না করে আমার বস Tarek Shikdar রে মেসেজ দে 🐸",
              ...
              "Hi 🙃",
              "hae bolo Jan pakhi 🎀✨",
              "হ্যাঁ টুনটুনি বলো 🤭","আমি তোরে সাহায্য করতে পারবো না কারণ তুই অনেক পচা!!😬","_আমাকে না ডেকে আমার বস Tarek কে ডাক দে😝","আমাকে এত ডাকিস কেন!🐥","hae bolo Jan pakhi","হুম বলো না বাবু 🥺",
              "জানু হাঙ্গা করবা🙈","কি বলবা আমার বসের কাছে বল🦆💨","hussss😼",
            ];
